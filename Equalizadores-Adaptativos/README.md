...
| [#4 - Desempenho_CPU_GPU](./Desempenho_CPU_GPU.ipynb) e  [Desempenho_CPU_GPU_PC](./Desempenho_CPU_GPU_PC.ipynb) | Análise comparativa de desempenho entre CPU (NumPy) e GPU (CuPy), incluindo tempo de execução, convergência e métricas de BER/SNR. |
