...
| [#4 - Desempenho_CPU_GPU](./4.1-Desempenho_CPU_GPU.ipynb) e  [Desempenho CPU_GPU_PC](./4.2-%esempenho%20CPU_GPU_PC.ipynb) | Análise comparativa de desempenho entre CPU (NumPy) e GPU (CuPy), incluindo tempo de execução, convergência e métricas de BER/SNR. |
